...
class Store{
  ...
  //     }
  //     List<CartItem> prods = (await ApiV2.getCart(Global.discountCode,null))!.cartList;
  ...
  // static save_recently(List<Product> _products){
  //   SharedPreferences.getInstance().then((prefs) {
  ...
  //
  // static Future<List<Product>> load_recently()async{
  //   try{
  //     SharedPreferences prefs = await SharedPreferences.getInstance();
