...
class OrderItems extends StatelessWidget {
  ...
  OrderItems(int orderId,String code){
    this.code = code;
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: (){
                                      homeController.go_to_product_by_id(myOrderController.orderDetails[index].id);
                                    },
                                    child: Container(
                                      width:120,
                                      height: 120,
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text(myOrderController.orderDetails[index].getTitle(),style: const TextStyle(color: Colors.grey,fontSize: 12,overflow: TextOverflow.ellipsis,),maxLines: 2,),
                                          ],
                                        ),
                                      ),
                                      Row(
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                Text(myOrderController.orderDetails[index].countForOrderItem.toString(),style: const TextStyle(color: Colors.grey,fontSize: 12,overflow: TextOverflow.ellipsis),),
                                              ],
                                            ),
                                            Row(
                                              children: [
                                                ...
                                                Text((myOrderController.orderDetails[index].countForOrderItem*myOrderController.orderDetails[index].price).toStringAsFixed(2)+" "+App_Localization.of(context).translate("aed"),style: TextStyle(color: App.midOrange,fontSize: 12,overflow: TextOverflow.ellipsis),),
                                              ],
                                            ),
                                          ],
                                        ),
